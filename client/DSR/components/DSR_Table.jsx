          ...
          <table className="min-w-full bg-white content-center table-auto">
            <thead>
              <tr>
                ...
                <th className="text-[13px] py-2 px-2 bg-gray-100 border border-neutral-600 mb-2">
                  Sr. No.
                </th>
                {columns.map((column) => (
                  <th
              ...
              {data.length > 0 ? (
                data.map((entry, index) => (
                  ...
                  >
                    ...
                    <td className="py-2 mt-2 border border-neutral-600 px-2 border-collapse">
                      {index + 1}
                    </td>
                    {columns.map((column) => (
                      <td
