  ...
  return (
    <div className="relative p-3 flex-col">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <label className="input-label text-lg text-slate-500">
            Component Name
          </label>
          <input
            type="text"
