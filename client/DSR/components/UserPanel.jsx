...
const UserPanel = () => {
  ...
  const sortUsers = (users) => {
    return users.sort((a, b) => {
      ...
      const deptA =
        a.departments && a.departments[0] && a.departments[0].name
          ? a.departments[0].name.toLowerCase()
          : "";
      const deptB =
        b.departments && b.departments[0] && b.departments[0].name
          ? b.departments[0].name.toLowerCase()
          : "";
        ...
        <table className="bg-white border border-gray-300 rounded-lg shadow-md w-full">
          <thead>
            <tr className="bg-gray-200 text-gray-700 text-left text-xl">
              <th className="border-b border-gray-300 px-6 py-3 font-semibold">
                Full Name
              </th>
              <th className="border-b border-gray-300 px-6 py-3 font-semibold">
                Email
