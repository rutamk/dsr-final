...
const AddEditDepartment = () => {
  ...
  <div className="container mt-4 mx-auto p-4 max-w-full h-max sm:max-w-md md:max-w-xl lg:max-w-xl xl:max-w-xl bg-slate-50 border border-slate-400 rounded-lg shadow-md">
    ...
    <table className="bg-white border border-gray-200 rounded-lg w-full h-[40vh] mt-5">
  <thead>
    <tr>
      <th className="bg-gray-200 text-gray-700 text-xl border-b border-gray-300 px-4 py-2 font-semibold text-center w-1/2">
        Department Name
      </th>
      <th className="bg-gray-200 text-gray-700 text-xl border-b border-gray-300 px-4 py-2 font-semibold text-center w-1/2">
        Labs
  ...
  <tbody>
    {departments.map((department) => (
      ...
      >
        <td className="border-b px-4 py-3 text-center">{department.deptName}</td>
